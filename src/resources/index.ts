...
export function registerResources(server: McpServer): void {
  server.resource(
    ...
    {
      description:
        "Project context with suite tree, tags, requirements, custom fields, and project users. Use this to resolve human-readable names (e.g. suite title, user name) to numeric IDs.",
      mimeType: "application/json",
    },
    async (uri, variables) => {
